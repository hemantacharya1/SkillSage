...
import { Plus, Calendar, Clock, Users, Loader2, AlertCircle } from 'lucide-react';
...
import { fetchInterviews, createInterview } from '@/redux/slices/interviewSlice';
...
const RecruiterDashboard = () => {
  ...
  const handleCreateInterview = async (newInterview) => {
    try {
      await dispatch(createInterview(newInterview)).unwrap();
